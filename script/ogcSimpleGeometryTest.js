...
require([
...
], function (dom, on, SimpleGeometry, ogcAgs, Dialog, Map, ArcGISTiledMapServiceLayer, Draw, Graphic, Extent, GraphicsLayer, SimpleRenderer, SimpleMarkerSymbol, SimpleLineSymbol, SimpleFillSymbol) {
	"use strict";
	...
	*/
	...
	function init() {
		...
		basemap = new ArcGISTiledMapServiceLayer("http://services.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer");
